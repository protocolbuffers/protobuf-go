...
const file_cmd_protoc_gen_go_testdata_issue780_oneof_conflict_test_proto_rawDesc = "\n=cmd/protoc-gen-go/testdata/issue780_oneof_conflict/test.proto	oneoftest\"'\nFoo\nget_bar (	H\x00RgetBarB\nbarBOZMgoogle.golang.org/protobuf/cmd/protoc-gen-go/testdata/issue780_oneof_conflict"
...
func file_cmd_protoc_gen_go_testdata_issue780_oneof_conflict_test_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: []byte(file_cmd_protoc_gen_go_testdata_issue780_oneof_conflict_test_proto_rawDesc),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
