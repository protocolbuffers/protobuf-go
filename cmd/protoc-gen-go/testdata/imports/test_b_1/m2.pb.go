...
const file_cmd_protoc_gen_go_testdata_imports_test_b_1_m2_proto_rawDesc = "\n4cmd/protoc-gen-go/testdata/imports/test_b_1/m2.prototest.b.part2\"\nM2BMZKgoogle.golang.org/protobuf/cmd/protoc-gen-go/testdata/imports/test_b_1;betabproto3"
...
func file_cmd_protoc_gen_go_testdata_imports_test_b_1_m2_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: []byte(file_cmd_protoc_gen_go_testdata_imports_test_b_1_m2_proto_rawDesc),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
