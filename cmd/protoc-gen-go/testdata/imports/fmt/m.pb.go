...
const file_cmd_protoc_gen_go_testdata_imports_fmt_m_proto_rawDesc = "\n.cmd/protoc-gen-go/testdata/imports/fmt/m.protofmt\"\nMBCZAgoogle.golang.org/protobuf/cmd/protoc-gen-go/testdata/imports/fmtbproto3"
...
func file_cmd_protoc_gen_go_testdata_imports_fmt_m_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: []byte(file_cmd_protoc_gen_go_testdata_imports_fmt_m_proto_rawDesc),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
