...
const file_cmd_protoc_gen_go_testdata_imports_test_import_a1m1_proto_rawDesc = "\n9cmd/protoc-gen-go/testdata/imports/test_import_a1m1.prototest4cmd/protoc-gen-go/testdata/imports/test_a_1/m1.proto\" \nA1M1\nf (2\n.test.a.M1RfB?Z=google.golang.org/protobuf/cmd/protoc-gen-go/testdata/importsbproto3"
...
func file_cmd_protoc_gen_go_testdata_imports_test_import_a1m1_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: []byte(file_cmd_protoc_gen_go_testdata_imports_test_import_a1m1_proto_rawDesc),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
