...
const file_cmd_protoc_gen_go_testdata_nameclash_test_name_clash_open_proto_rawDesc = "\n?cmd/protoc-gen-go/testdata/nameclash/test_name_clash_open.proto$net.proto2.go.testdata.nameclashopen!google/protobuf/go_features.proto\"O\nM1\nfoo (Rfoo\nget_foo (RgetFoo\nget_get_foo (R	getGetFoo\"O\nM2\nget_get_foo (R	getGetFoo\nget_foo (RgetFoo\nfoo (Rfoo\"O\nM3\nget_foo (RgetFoo\nget_get_foo (R	getGetFoo\nfoo (Rfoo\"g\nM4\nget_foo (RgetFoo'\nget_get_get_foo (H\x00RgetGetGetFoo\nfoo (RfooB\r\nget_get_foo\"d\nM5\nget_foo (RgetFoo \nget_get_foo (H\x00R	getGetFoo\nfoo (RfooB\nget_get_get_foo\"g\nM6'\nget_get_get_foo (H\x00RgetGetGetFoo\nget_foo (RgetFoo\nfoo (RfooB\r\nget_get_foo\"T\nM7\nbar (H\x00Rbar\nget_foo (H\x00RgetFoo\nfoo (RfooB\r\nget_get_foo\"d\nM8 \nget_get_foo (H\x00R	getGetFoo\nget_foo (RgetFoo\nfoo (RfooB\nget_get_get_foo\"f\nM9 \nget_get_foo (H\x00R	getGetFoo\nget_foo (H\x00RgetFoo\nfoo (RfooB\nget_get_get_fooB^ZTgoogle.golang.org/protobuf/cmd/protoc-gen-go/testdata/nameclash/test_name_clash_open\x92\xd2>beditionsp\xe8"
