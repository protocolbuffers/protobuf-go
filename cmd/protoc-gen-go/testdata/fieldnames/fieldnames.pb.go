...
const file_cmd_protoc_gen_go_testdata_fieldnames_fieldnames_proto_rawDesc = "\n6cmd/protoc-gen-go/testdata/fieldnames/fieldnames.protogoproto.protoc.fieldnames\"\xb8\nMessage\n	field_one (	RfieldOne\nFieldTwo (	RFieldTwo\n\nfieldThree (	R\nfieldThree\nfield__four (	R	fieldFour\n\ndescriptor\n (	R\ndescriptor\nmarshal (	Rmarshal\n	unmarshal (	R	unmarshal#\n\rproto_message\r (	RprotoMessage\n	CamelCase (	R	CamelCase\n\nCamelCase_ (	R	CamelCase\n\ncamel_case (	R	camelCase\nCamelCase__ (	R	CamelCase\nget_name (	RgetName\nname (	Rname(\nOneofConflictA( (	H\x00ROneofConflictA,\noneof_no_conflict2 (	HRoneofNoConflict(\nOneofConflictB3 (	HROneofConflictB6\noneof_message_conflict< (	HRoneofMessageConflict\nOneofMessageConflictB\noneof_conflict_aB\noneof_conflict_bB\noneof_conflict_cBBZ@google.golang.org/protobuf/cmd/protoc-gen-go/testdata/fieldnames"
...
func file_cmd_protoc_gen_go_testdata_fieldnames_fieldnames_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: []byte(file_cmd_protoc_gen_go_testdata_fieldnames_fieldnames_proto_rawDesc),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
