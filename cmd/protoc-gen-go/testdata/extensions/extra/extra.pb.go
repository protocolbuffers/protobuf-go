...
const file_cmd_protoc_gen_go_testdata_extensions_extra_extra_proto_rawDesc = "\n7cmd/protoc-gen-go/testdata/extensions/extra/extra.protogoproto.protoc.extension.extra\"\"\nExtraMessage\ndata (RdataBHZFgoogle.golang.org/protobuf/cmd/protoc-gen-go/testdata/extensions/extra"
...
func file_cmd_protoc_gen_go_testdata_extensions_extra_extra_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: []byte(file_cmd_protoc_gen_go_testdata_extensions_extra_extra_proto_rawDesc),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
