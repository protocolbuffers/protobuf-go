...
const file_cmd_protoc_gen_go_testdata_comments_comments_proto_rawDesc = "\n2cmd/protoc-gen-go/testdata/comments/comments.protogoproto.protoc.comments\"{\nMessage1\nField1A (	RField1A&\n\rOneof1AField1 (	H\x00R\rOneof1AField1\n	Message1A\n	Message1B*d\x80\x80\x80\x80B	\nOneof1a\"$\nMessage2\n	Message2A\n	Message2B*\nEnum1\nFOO\x00\nBAR:b\n	extension!.goproto.protoc.comments.Message1d (2!.goproto.protoc.comments.Message1R	extensionB@Z>google.golang.org/protobuf/cmd/protoc-gen-go/testdata/comments"
...
func file_cmd_protoc_gen_go_testdata_comments_comments_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: []byte(file_cmd_protoc_gen_go_testdata_comments_comments_proto_rawDesc),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 1,
			NumServices:   0,
