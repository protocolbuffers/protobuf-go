...
const file_cmd_protoc_gen_go_testdata_import_public_c_proto_rawDesc = "\n0cmd/protoc-gen-go/testdata/import_public/c.protogoproto.protoc.import_public0cmd/protoc-gen-go/testdata/import_public/a.proto\"\x92\nUsingPublicImport9\nlocal (2#.goproto.protoc.import_public.LocalRlocalB\nsub2 (2..goproto.protoc.import_public.sub2.Sub2MessageRsub2BEZCgoogle.golang.org/protobuf/cmd/protoc-gen-go/testdata/import_public"
...
func file_cmd_protoc_gen_go_testdata_import_public_c_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: []byte(file_cmd_protoc_gen_go_testdata_import_public_c_proto_rawDesc),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
