...
const file_cmd_protoc_gen_go_testdata_import_public_sub_b_proto_rawDesc = "\n4cmd/protoc-gen-go/testdata/import_public/sub/b.proto goproto.protoc.import_public.sub\"\nM2BIZGgoogle.golang.org/protobuf/cmd/protoc-gen-go/testdata/import_public/sub"
...
func file_cmd_protoc_gen_go_testdata_import_public_sub_b_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: []byte(file_cmd_protoc_gen_go_testdata_import_public_sub_b_proto_rawDesc),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
