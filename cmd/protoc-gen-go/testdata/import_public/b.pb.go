...
const file_cmd_protoc_gen_go_testdata_import_public_b_proto_rawDesc = "\n0cmd/protoc-gen-go/testdata/import_public/b.protogoproto.protoc.import_public4cmd/protoc-gen-go/testdata/import_public/sub/a.proto\"m\nLocal1\nm (2#.goproto.protoc.import_public.sub.MRm1\ne (2#.goproto.protoc.import_public.sub.EReBEZCgoogle.golang.org/protobuf/cmd/protoc-gen-go/testdata/import_public"
...
func file_cmd_protoc_gen_go_testdata_import_public_b_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: []byte(file_cmd_protoc_gen_go_testdata_import_public_b_proto_rawDesc),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
