...
const file_cmd_protoc_gen_go_testdata_import_public_sub2_a_proto_rawDesc = "\n5cmd/protoc-gen-go/testdata/import_public/sub2/a.proto!goproto.protoc.import_public.sub2\"\r\nSub2MessageBJZHgoogle.golang.org/protobuf/cmd/protoc-gen-go/testdata/import_public/sub2"
...
func file_cmd_protoc_gen_go_testdata_import_public_sub2_a_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: []byte(file_cmd_protoc_gen_go_testdata_import_public_sub2_a_proto_rawDesc),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
