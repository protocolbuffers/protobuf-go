...
func (*TestAllExtensions_NestedMessage) Descriptor() ([]byte, []int) {
	return file_test_test_proto_rawDescGZIP(), []int{4, 0}
}
...
var file_test_test_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
...
func file_test_test_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_test_test_proto_msgTypes[42].Exporter = func(v interface{}, i int) interface{} {
