...
const file_internal_testprotos_textpbeditions_textpbeditions_opaque_test2_opaque_proto_rawDesc = "\nKinternal/testprotos/textpbeditions/textpbeditions_opaque/test2.opaque.protoopaque.pbeditionsgoogle/protobuf/any.protogoogle/protobuf/duration.protogoogle/protobuf/empty.proto google/protobuf/field_mask.protogoogle/protobuf/struct.protogoogle/protobuf/timestamp.protogoogle/protobuf/wrappers.proto!google/protobuf/go_features.proto\"\xda\nScalars\nopt_bool (RoptBool\n	opt_int32 (RoptInt32\n	opt_int64 (RoptInt64\n\nopt_uint32 (\rR	optUint32\n\nopt_uint64 (R	optUint64\n\nopt_sint32 (R	optSint32\n\nopt_sint64 (R	optSint64\nopt_fixed32 (R\noptFixed32\nopt_fixed64	 (R\noptFixed64!\nopt_sfixed32\n (RoptSfixed32!\nopt_sfixed64 (RoptSfixed64\n	opt_float (RoptFloat\n\nopt_double (R	optDouble\n	opt_bytes (RoptBytes\n\nopt_string\r (	R	optString\"\x8f\nImplicitScalars\ns_bool (B\xaaRsBool\ns_int32 (B\xaaRsInt32\ns_int64 (B\xaaRsInt64 \ns_uint32 (\rB\xaaRsUint32 \ns_uint64 (B\xaaRsUint64 \ns_sint32 (B\xaaRsSint32 \ns_sint64 (B\xaaRsSint64\"\n	s_fixed32 (B\xaaRsFixed32\"\n	s_fixed64	 (B\xaaRsFixed64$\n\ns_sfixed32\n (B\xaaR	sSfixed32$\n\ns_sfixed64 (B\xaaR	sSfixed64\ns_float (B\xaaRsFloat \ns_double (B\xaaRsDouble\ns_bytes (B\xaaRsBytes \ns_string\r (	B\xaaRsString\"C\n\rUTF8Validated2\nvalidated_string (	B\xaa RvalidatedString\"c\nNestsUTF8ValidatedM\nvalidated_message (2 .opaque.pbeditions.UTF8ValidatedRvalidatedMessage\"\xa1\nEnums2\nopt_enum (2.opaque.pbeditions.EnumRoptEnum2\nrpt_enum (2.opaque.pbeditions.EnumRrptEnumG\n\rimplicit_enum (2.opaque.pbeditions.OpenEnumB\xaaRimplicitEnumK\nopt_nested_enum (2#.opaque.pbeditions.Enums.NestedEnumR\roptNestedEnumK\nrpt_nested_enum (2#.opaque.pbeditions.Enums.NestedEnumR\rrptNestedEnum`\nimplicit_nested_enum (2'.opaque.pbeditions.Enums.NestedOpenEnumB\xaaRimplicitNestedEnum\"(\n\nNestedEnum\nUNO\nDOS\nDIEZ\n\"A\nNestedOpenEnum\nUNKNOWN\x00\nEINS\nZWEI\nZEHN\n:\"\x94\nRepeats\nrpt_bool (RrptBool\n	rpt_int32 (RrptInt32\n	rpt_int64 (RrptInt64\n\nrpt_uint32 (\rR	rptUint32\n\nrpt_uint64 (R	rptUint64\n	rpt_float (RrptFloat\n\nrpt_double (R	rptDouble\n\nrpt_string (	R	rptString\n	rpt_bytes	 (RrptBytes\"\xb9\nMapsI\nint32_to_str (2'.opaque.pbeditions.Maps.Int32ToStrEntryR\nint32ToStrL\n\rstr_to_nested (2(.opaque.pbeditions.Maps.StrToNestedEntryRstrToNested=\nInt32ToStrEntry\nkey (Rkey\nvalue (	Rvalue:8Y\nStrToNestedEntry\nkey (	Rkey/\nvalue (2.opaque.pbeditions.NestedRvalue:8\"a\nNested\n\nopt_string (	R	optString8\n\nopt_nested (2.opaque.pbeditions.NestedR	optNested\"\x80\nNests8\n\nopt_nested (2.opaque.pbeditions.NestedR	optNestedD\noptgroup (2!.opaque.pbeditions.Nests.OptGroupB\xaa(RoptgroupQ\ndelimited_field (2!.opaque.pbeditions.Nests.OptGroupB\xaa(RdelimitedField8\n\nrpt_nested (2.opaque.pbeditions.NestedR	rptNestedF\nrptgroup (2!.opaque.pbeditions.Nests.RptGroupB\xaa(Rrptgroup\xe6\nOptGroup\n\nopt_string (	R	optString8\n\nopt_nested (2.opaque.pbeditions.NestedR	optNested_\noptnestedgroup (20.opaque.pbeditions.Nests.OptGroup.OptNestedGroupB\xaa(Roptnestedgroupm\nnested_delimited_field (20.opaque.pbeditions.Nests.OptGroup.OptNestedGroupB\xaa(RnestedDelimitedField1\nOptNestedGroup\nopt_fixed32 (R\noptFixed32)\nRptGroup\n\nrpt_string (	R	rptStringRreserved_field\"\x9f\n	Requireds \nreq_bool (B\xaaRreqBool(\nreq_sfixed64 (B\xaaRreqSfixed64$\n\nreq_double (B\xaaR	reqDouble$\n\nreq_string (	B\xaaR	reqString9\nreq_enum (2.opaque.pbeditions.EnumB\xaaRreqEnum?\n\nreq_nested (2.opaque.pbeditions.NestedB\xaaR	reqNested\"V\nPartialRequired$\n\nreq_string (	B\xaaR	reqString\n\nopt_string (	R	optString\":\nNestedWithRequired$\n\nreq_string (	B\xaaR	reqString\"\xb4\nIndirectRequiredD\n\nopt_nested (2%.opaque.pbeditions.NestedWithRequiredR	optNestedD\n\nrpt_nested (2%.opaque.pbeditions.NestedWithRequiredR	rptNestedX\n\rstr_to_nested (24.opaque.pbeditions.IndirectRequired.StrToNestedEntryRstrToNestedJ\noneof_nested (2%.opaque.pbeditions.NestedWithRequiredH\x00RoneofNestede\nStrToNestedEntry\nkey (	Rkey;\nvalue (2%.opaque.pbeditions.NestedWithRequiredRvalue:8B\nunion\"i\n\nExtensions\n\nopt_string (	R	optString\nopt_boole (RoptBool\n	opt_int32 (RoptInt32*e\"\xbf\nExtensionsContainer2?\nopt_ext_bool.opaque.pbeditions.Extensions3 (R\noptExtBool2C\nopt_ext_string.opaque.pbeditions.Extensions4 (	RoptExtString2X\nopt_ext_enum.opaque.pbeditions.Extensions5 (2.opaque.pbeditions.EnumR\noptExtEnum2^\nopt_ext_nested.opaque.pbeditions.Extensions6 (2.opaque.pbeditions.NestedRoptExtNested2i\nopt_ext_partial.opaque.pbeditions.Extensions7 (2\".opaque.pbeditions.PartialRequiredR\roptExtPartial2C\nrpt_ext_string.opaque.pbeditions.Extensions= (	RrptExtString2X\nrpt_ext_enum.opaque.pbeditions.Extensions> (2.opaque.pbeditions.EnumR\nrptExtEnum2^\nrpt_ext_nested.opaque.pbeditions.Extensions? (2.opaque.pbeditions.NestedRrptExtNested\"\n\nMessageSet*\xff\xff\xff\xff:\"\x8b\nMessageSetExtension\n\nopt_string (	R	optString2y\nmessage_set_extension.opaque.pbeditions.MessageSet\n (2&.opaque.pbeditions.MessageSetExtensionRmessageSetExtension2\x80\nnot_message_set_extension.opaque.pbeditions.MessageSet (2&.opaque.pbeditions.MessageSetExtensionRnotMessageSetExtension2W\n\next_nested.opaque.pbeditions.MessageSet (2.opaque.pbeditions.NestedR	extNested\"\nFakeMessageSet*\x80\x80\x80\x80\"\xbc\nFakeMessageSetExtension\n\nopt_string (	R	optString2\x81\nmessage_set_extension!.opaque.pbeditions.FakeMessageSet\n (2*.opaque.pbeditions.FakeMessageSetExtensionRmessageSetExtension\"\x9e\n\nKnownTypes5\nopt_bool (2.google.protobuf.BoolValueRoptBool8\n	opt_int32 (2.google.protobuf.Int32ValueRoptInt328\n	opt_int64 (2.google.protobuf.Int64ValueRoptInt64;\n\nopt_uint32 (2.google.protobuf.UInt32ValueR	optUint32;\n\nopt_uint64 (2.google.protobuf.UInt64ValueR	optUint648\n	opt_float (2.google.protobuf.FloatValueRoptFloat;\n\nopt_double (2.google.protobuf.DoubleValueR	optDouble;\n\nopt_string (2.google.protobuf.StringValueR	optString8\n	opt_bytes	 (2.google.protobuf.BytesValueRoptBytes<\nopt_duration (2.google.protobuf.DurationRoptDuration?\n\ropt_timestamp (2.google.protobuf.TimestampRoptTimestamp6\n\nopt_struct (2.google.protobuf.StructR	optStruct5\nopt_list (2.google.protobuf.ListValueRoptList3\n	opt_value (2.google.protobuf.ValueRoptValue5\nopt_null (2.google.protobuf.NullValueRoptNull3\n	opt_empty (2.google.protobuf.EmptyRoptEmpty-\nopt_any  (2.google.protobuf.AnyRoptAny?\n\ropt_fieldmask( (2.google.protobuf.FieldMaskRoptFieldmask*!\nEnum\nONE\nTWO\nTEN\n*;\nOpenEnum\nUNKNOWN\x00\nEINS\nZWEI\nZEHN\n::?\nopt_ext_bool.opaque.pbeditions.Extensions (R\noptExtBool:C\nopt_ext_string.opaque.pbeditions.Extensions (	RoptExtString:X\nopt_ext_enum.opaque.pbeditions.Extensions (2.opaque.pbeditions.EnumR\noptExtEnum:^\nopt_ext_nested.opaque.pbeditions.Extensions (2.opaque.pbeditions.NestedRoptExtNested:i\nopt_ext_partial.opaque.pbeditions.Extensions (2\".opaque.pbeditions.PartialRequiredR\roptExtPartial:E\nrpt_ext_fixed32.opaque.pbeditions.Extensions (R\rrptExtFixed32:X\nrpt_ext_enum.opaque.pbeditions.Extensions  (2.opaque.pbeditions.EnumR\nrptExtEnum:^\nrpt_ext_nested.opaque.pbeditions.Extensions! (2.opaque.pbeditions.NestedRrptExtNested:}\nmessage_set_extension.opaque.pbeditions.MessageSet2 (2*.opaque.pbeditions.FakeMessageSetExtensionRmessageSetExtensionBaZSgoogle.golang.org/protobuf/internal/testprotos/textpbeditions/textpbeditions_opaque\x92	\xd2> beditionsp\xe8"
