...
const file_internal_testprotos_lazy_lazy_extension_normalized_wire_test_proto_rawDesc = "\nBinternal/testprotos/lazy/lazy_extension_normalized_wire_test.proto#lazy_extension_normalized_wire_test\"c\nSub\nc (\rRcH\n\ngrandchild (2(.lazy_extension_normalized_wire_test.SubR\ngrandchild*\"S\nTop\na (\rRa>\nchild (2(.lazy_extension_normalized_wire_test.SubRchild\"\x84\nExt\n	some_flag (RsomeFlag2`\nb(.lazy_extension_normalized_wire_test.Sub (2(.lazy_extension_normalized_wire_test.ExtRbB5Z3google.golang.org/protobuf/internal/testprotos/lazy"
