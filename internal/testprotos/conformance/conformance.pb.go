...
const file_conformance_conformance_proto_rawDesc = "\nconformance/conformance.protoconformance\"l\n\nTestStatus\nname (	Rname'\nfailure_message (	RfailureMessage!\nmatched_name (	RmatchedName\"?\n\nFailureSet+\ntest (2.conformance.TestStatusRtestJ\"\xf6\nConformanceRequest+\nprotobuf_payload (H\x00RprotobufPayload#\njson_payload (	H\x00RjsonPayload#\njspb_payload (	H\x00RjspbPayload#\ntext_payload (	H\x00RtextPayloadO\nrequested_output_format (2.conformance.WireFormatRrequestedOutputFormat!\nmessage_type (	RmessageType>\n\rtest_category (2.conformance.TestCategoryRtestCategoryS\njspb_encoding_options (2.conformance.JspbEncodingConfigRjspbEncodingOptions0\nprint_unknown_fields	 (RprintUnknownFieldsB	\npayload\"\xf3\nConformanceResponse!\nparse_error (	H\x00R\nparseError)\nserialize_error (	H\x00RserializeError%\n\rtimeout_error	 (	H\x00RtimeoutError%\n\rruntime_error (	H\x00RruntimeError+\nprotobuf_payload (H\x00RprotobufPayload#\njson_payload (	H\x00RjsonPayload\nskipped (	H\x00Rskipped#\njspb_payload (	H\x00RjspbPayload#\ntext_payload (	H\x00RtextPayloadB\nresult\"N\nJspbEncodingConfig8\nuse_jspb_array_any_format (RuseJspbArrayAnyFormat*P\n\nWireFormat\nUNSPECIFIED\x00\nPROTOBUF\nJSON\nJSPB\nTEXT_FORMAT*\x8f\nTestCategory\nUNSPECIFIED_TEST\x00\nBINARY_TEST\r\n	JSON_TEST$\n JSON_IGNORE_UNKNOWN_PARSING_TEST\r\n	JSPB_TEST\nTEXT_FORMAT_TESTB/\ncom.google.protobuf.conformance\xa2Conformancebproto3"
