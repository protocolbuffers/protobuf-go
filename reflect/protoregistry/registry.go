...
//
//	go build -ldflags "-X github.com/infiniteloopcloud/protoc-gen-go-types/reflect/protoregistry.conflictPolicy=warn"
//
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	currPath := "github.com/infiniteloopcloud/protoc-gen-go-types/types/known/" + pkgName
	panic(fmt.Sprintf(""+
